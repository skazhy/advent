...
(deftest ^:intcode puzzle2
  (testing "Examples"
    (is (= 139629729 (d/puzzle2 [3 26 1001 26 -4 26 3 27 1002 27 2 27 1 27 26
                                 27 4 27 1001 28 -1 28 1005 28 6 99 0 0 5])))

    (is (= 18216 (d/puzzle2 [3 52 1001 52 -5 52 3 53 1 52 56 54 1007 54 5
  ...
  (testing "Actual input"
    (is (= 44282086 (d/puzzle2 d/puzzle-input)))))
